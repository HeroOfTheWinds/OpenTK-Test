...
namespace JustTheBasics
{
    class GameObject
    {
        ...
        public GameObject(String name, Vector2[] spawnCoords, float[] inputmap, float ispeed, float acceleration, bool collision, Sprite spr)
        {
            sprite = spr;
            col = collision;
            objectname = name;
            ...
            {
                Console.WriteLine("ERROR: Spawn failed: Could not spawn object, invalid coordinates.");
            }
        ...
        public virtual void Update()
        {
            ...
            sprite.Position.X = loc[0][0];
            sprite.Position.Y = loc[0][1];
            minX = loc[0][0];
            minY = loc[0][1];
            maxX = loc[2][0];
            maxY = loc[2][1];
